...
print(mensaje) #No pide imprimir, pero interpreto que debo hacerlo
...
##Ejercicio4
##Crear dos funciones: calcular_area_circulo(radio) que reciba el radio como parámetro y devuelva el área del círculo. calcular_perimetro_ circulo(radio) que reciba el radio como parámetro y devuelva el perímetro del círculo. Solicitar el radio al usuario y llamar ambas funciones para mostrar los resultados.
...
a = int(input("Ingrese el primer número que no sea 0: "))
b = int(input("Ingrese el segundo número que no sea 0: "))

resultado = operaciones_basicas(a, b)

print(f"La suma es {resultado[0]}, la resta es {resultado[1]}, la multiplicación es {resultado[2]}, la división es {resultado[3]} ")
...
print(F"El ICM es de: {indice_masa_corporal}")
...
print(f"La equivalencia en grados Fahrenheit es de: {temperatura}")
...
a = float(input("Ingrese la primera número: "))
b = float(input("Ingrese la segunda número: "))
c = float(input("Ingrese la tercera número: "))

nota_final = calcular_promedio(a, b, c)
print(f"El promedio de los números {nota_final}")